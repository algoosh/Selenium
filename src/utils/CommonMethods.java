...
//Command O ---> will give all the methods that are exist in THAT class
...
public class CommonMethods {
	 ...
	 * @param frame index
	 */
	public static void switchToFrame(int indext) {
		try {
			driver.switchTo().frame(indext);
	...
	/**
	 * Method that will handle radio buttons
